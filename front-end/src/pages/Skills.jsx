  ...
  return (
    <div className="containers skills">
      <div className="inner">
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <polygon
                ...
                fill={hoverStates.html ? "#344f26" : "#000000"}
              ></polygon>
              <polygon
                points="16 27.858 24.17 25.593 26.092 4.061 16 4.061 16 27.858"
                fill={hoverStates.html ? "#f1662a" : "#000000"}
              ></polygon>
              <polygon
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill={hoverStates.css ? "#1172B8" : "#000000"}
              ></path>
              <path
                d="M26 5H16V29.5L24 27L26 5Z"
                fill={hoverStates.css ? "#33AADD" : "#000000"}
              ></path>
              <path
        ...
        >
          <p className="tooltip">JS</p>
          <svg
            className="js"
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
            fill={hoverStates.js ? "#000000" : "#fff"}
          >
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g
              id="SVGRepo_tracerCarrier"
            ...
            <g id="SVGRepo_iconCarrier">
              <rect
                ...
                width="28"
                height="28"
                fill={hoverStates.js ? "#f5de19" : "#000000"}
              ></rect>
          ...
          >
            <defs>
              ...
              >
                <stop
                  offset="0"
                  stopColor={hoverStates.php ? "#ffffff" : "#000000"}
                />
                <stop
                  offset="0.5"
                  stopColor={hoverStates.php ? "#4c6b96" : "#000000"}
                />
                <stop
                  offset="1"
                  stopColor={hoverStates.php ? "#231f20" : "#000000"}
                />
              </radialGradient>
            </defs>
            <ellipse
              ...
              rx="14"
              ry="7.365"
              fill={hoverStates.php ? "url(#a)" : "#000000"}
            />
            <ellipse
              cx="16"
              cy="16"
              rx="13.453"
              ry="6.818"
              fill={hoverStates.php ? "#6280b6" : "#000000"}
            />
            <path
              ...
              fill={hoverStates.php ? "#ffffff" : "#fff"}
            />
            <path
            ...
            <path
              ...
              fill={hoverStates.php ? "#000" : "#ffffff"}
            />
            <path
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill={hoverStates.mysql ? "#00546B" : "#000"}
              ></path>
              <path
        ...
        <div
          className={`box ${isVisible ? "fade-in" : ""}`}
          onMouseEnter={() => handleMouseEnter("mongod")}
          onMouseLeave={() => handleMouseLeave("mongod")}
        >
          <p className="tooltip">Mongodb</p>
          <svg
            className="mongod"
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="SVGRepo_iconCarrier">
              <defs>
                ...
                >
                  <stop
                    offset="0"
                    stopColor={hoverStates.mongod ? "#48a547" : "#000"}
                  ></stop>
                  <stop
                    offset="1"
                    stopColor={hoverStates.mongod ? "#3f9143" : "#000"}
                  ></stop>
                </linearGradient>
                <linearGradient
                  id="c"
                ...
                >
                  <stop
                    offset="0"
                    stopColor={hoverStates.mongod ? "#41a247" : "#202020"}
                  ></stop>
                  <stop
                    offset="0.352"
                    stopColor={hoverStates.mongod ? "#4ba74b" : "#202020"}
                  ></stop>
                  <stop
                    offset="0.956"
                    stopColor={hoverStates.mongod ? "#67b554" : "#202020"}
                  ></stop>
                  <stop
                    offset="1"
                    stopColor={hoverStates.mongod ? "#69b655" : "#202020"}
                  ></stop>
                </linearGradient>
              </defs>
              <path
                ...
                fill={hoverStates.mongod ? "url(#a)" : "#202124"}
              ></path>
              <path
                ...
                fill={hoverStates.mongod ? "url(#b)" : "#000"}
              ></path>
              <path
                ...
                fill={hoverStates.mongod ? "url(#c)" : "#303030"}
              ></path>
            </g>
          </svg>
        </div>
        <div
          className={`box ${isVisible ? "fade-in" : ""}`}
          onMouseEnter={() => handleMouseEnter("ex")}
          onMouseLeave={() => handleMouseLeave("ex")}
        >
          <p className="tooltip">Express js</p>
          <svg
            className="express"
            fill={hoverStates.ex ? "#8CC84B" : "#000"}
            viewBox="0 0 24 24"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill={hoverStates.node ? "#8CC84B" : "#000"}
              ></path>
              <path
        ...
        >
          <p className="tooltip">React js</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            aria-hidden="true"
            ...
            viewBox="0 0 256 228"
            fill={hoverStates.react ? "#00d8ff" : "#000"}
          >
        ...
        <div
          className={`box ${isVisible ? "fade-in" : ""}`}
          onMouseEnter={() => handleMouseEnter("cpp")}
          onMouseLeave={() => handleMouseLeave("cpp")}
        >
          <p className="tooltip">C++</p>
          <svg
            className="cpp"
            viewBox="0 0 256 288"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <path
              ...
              fill={hoverStates.cpp ? "#5C8DBC" : "#000"}
            />
            <path
              ...
              fill={hoverStates.cpp ? "#1A4674" : "#000"}
            />
            <path
            ...
            <path
              ...
              fill={hoverStates.cpp ? "#1B598E" : "#000"}
            />
            <path
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill={hoverStates.java ? "#E5E4E2 " : "#000"}
              ></path>
              <path
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill={
                  hoverStates.python ? "url(#paint0_linear_87_8204)" : "#000"
                }
              ></path>
              <path
                fillRule="evenodd"
                ...
                fill={
                  hoverStates.python ? "url(#paint1_linear_87_8204)" : "#fff"
                }
              ></path>
              <defs>
                <linearGradient
        ...
        <div
          className={`box ${isVisible ? "fade-in" : ""}`}
          onMouseEnter={() => handleMouseEnter("kot")}
          onMouseLeave={() => handleMouseLeave("kot")}
        >
          <p className="tooltip">Kotlin</p>
          <svg
            viewBox="0 0 256 256"
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <defs>
                ...
                >
                  <stop
                    stopColor={hoverStates.kot ? "#0095D5" : "#000"}
                    offset="9.677%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#238AD9" : "#000"}
                    offset="30.07%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#557BDE" : "#000"}
                    offset="62.11%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#7472E2" : "#000"}
                    offset="86.43%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#7472E2" : "#000"}
                ...
                >
                  ...
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#3C83DC" : "#000"}
                    offset="41.78%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#6D74E1" : "#000"}
                    offset="69.62%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#7472E2" : "#000"}
                ...
                >
                  <stop
                    stopColor={hoverStates.kot ? "#C757BC" : "#fff"}
                    offset="10.75%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#D0609A" : "#fff"}
                    offset="21.38%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#E1725C" : "#fff"}
                    offset="42.54%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#EE7E2F" : "#fff"}
                    offset="60.48%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#F58613" : "#fff"}
                    offset="74.3%"
                  ></stop>
                  <stop
                    stopColor={hoverStates.kot ? "#F88909" : "#fff"}
                    offset="82.32%"
                  ></stop>
                </linearGradient>
              </defs>
        ...
        <div className={`box ${isVisible ? "fade-in" : ""}`}>
          <p className="tooltip">Data Structures</p>
          <svg
          ...
          >
            <path
              d="M344.32 284.16h336v119.68H344.32zM344.32 451.84h336v119.68H344.32zM344.32 620.16h336v119.68H344.32z"
              fill="#fff"
            />
            <path
              d="M140.16 451.84h119.68v120.32H140.16zM764.16 451.84h119.68v120.32h-119.68z"
              fill="#fff"
            />
            <path
              d="M824.32 272A72.32 72.32 0 1 1 896 200.32a72.32 72.32 0 0 1-71.68 71.68z m0-119.68a48 48 0 1 0 48 48 48 48 0 0 0-48-48zM800 355.84h-83.84v-23.68h83.84a12.16 12.16 0 0 0 12.16-12.16v-23.68h24.32V320a35.84 35.84 0 0 1-35.84 35.84z"
              fill="#000"
            />
            <path
              d="M812.16 188.16h23.68v23.68h-23.68zM200.32 272a72.32 72.32 0 1 1 71.68-71.68 72.32 72.32 0 0 1-71.68 71.68z m0-119.68a48 48 0 1 0 48 48 48 48 0 0 0-48-48zM307.84 355.84H224A35.84 35.84 0 0 1 188.16 320v-23.68h24.32V320a12.16 12.16 0 0 0 12.16 12.16h83.2z"
              fill="#000"
            />
            <path
              d="M188.16 188.16h23.68v23.68h-23.68zM824.32 896A72.32 72.32 0 1 1 896 824.32 72.32 72.32 0 0 1 824.32 896z m0-119.68a48 48 0 1 0 48 48 48 48 0 0 0-48-48zM835.84 728.32h-23.68V704a12.16 12.16 0 0 0-12.16-12.16h-83.84v-23.68h83.84a35.84 35.84 0 0 1 35.84 35.84z"
              fill="#000"
            />
            <path
              d="M812.16 812.16h23.68v23.68h-23.68zM200.32 896a72.32 72.32 0 1 1 72.32-71.68A72.32 72.32 0 0 1 200.32 896z m0-119.68a48 48 0 1 0 48 48 48 48 0 0 0-48-48zM211.84 728.32h-23.68V704a35.84 35.84 0 0 1 35.84-35.84h83.84v24.32H224a12.16 12.16 0 0 0-12.16 12.16z"
              fill="#000"
            />
            <path
              d="M188.16 812.16h23.68v23.68h-23.68zM691.84 476.16h-23.68v-12.16H355.84v12.16h-23.68v-35.84h359.68v35.84zM691.84 584.32H332.16v-36.48h23.68v12.16h312.32v-12.16h23.68v36.48zM451.84 499.84h23.68v23.68h-23.68zM499.84 499.84h23.68v23.68h-23.68zM547.84 499.84h23.68v23.68h-23.68zM691.84 416H332.16V272h360.32z m-336-23.68h312.32v-96H355.84z"
              fill="#000"
            />
            <path
              d="M451.84 332.16h23.68v24.32h-23.68zM499.84 332.16h23.68v24.32h-23.68zM547.84 332.16h23.68v24.32h-23.68zM691.84 752H332.16V608h360.32z m-336-23.68h312.32v-96H355.84z"
              fill="#000"
            />
            <path
              d="M451.84 668.16h23.68v24.32h-23.68zM499.84 668.16h23.68v24.32h-23.68zM547.84 668.16h23.68v24.32h-23.68zM896 584.32h-144V440.32H896z m-119.68-23.68h96V464h-96z"
              fill="#000"
            />
            <path
              d="M668.16 499.84h96v23.68h-96zM812.16 499.84h23.68v23.68h-23.68zM272 584.32H128V440.32h144z m-119.68-24.32h96v-96h-96z"
              fill="#000"
            />
            <path
              d="M259.84 499.84h96v23.68h-96zM188.16 499.84h23.68v23.68h-23.68z"
              fill="#000"
            />
          </svg>
        </div>
        ...
        >
          <p className="tooltip">Google docs</p>
          <svg
            className="docs"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 48 48"
          ...
          >
            ...
            >
              <stop
                offset="0"
                stopColor={hoverStates.docs ? "#55adfd" : "#000"}
              />
              <stop
                offset="1"
                stopColor={hoverStates.docs ? "#438ffd" : "#000"}
              />
            </linearGradient>
            <path
              fill="url(#pg10I3OeSC0NOv22QZ6aWa)"
            ...
            >
              <stop
                offset="0"
                stopColor={hoverStates.docs ? "#427fdb" : "#fff"}
              />
              <stop
                offset="1"
                stopColor={hoverStates.docs ? "#0c52bb" : "#fff"}
              />
            </linearGradient>
            <path
              fill="url(#pg10I3OeSC0NOv22QZ6aWb)"
