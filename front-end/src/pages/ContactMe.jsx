      ...
      <div className="form">
        <div className="input-wrapper">
          ...
          {error.name && (
            <button
              className="ttp"
              aria-label="The entered name is invalid, Kindly enter a valid name."
            >
              <svg
                viewBox="0 0 16 16"
                fill="none"
        ...
        <div className="input-wrapper">
          ...
          {error.email && (
            <button
              className="ttp"
              aria-label="The entered email is not valid, Kindly enter a valid email."
            >
              <svg
                viewBox="0 0 16 16"
                fill="none"
        ...
        <div className="input-wrapper">
          ...
          {error.number && (
            <button
              className="ttp"
              aria-label="Phone number has to 10 digits long, Kindly enter a valid phone number."
            >
              <svg
                viewBox="0 0 16 16"
                fill="none"
        ...
        <div className="input-wrapper">
          ...
          {error.message && (
            <button
              className="ttp"
              aria-label="Only punctuation, words, and numbers are allowed.."
            >
              <svg
                viewBox="0 0 16 16"
                fill="none"
